                        ...
                        case "previous"
                            return
                                if ($book2 eq "") then
                                    ...
                                    <a
                                        href="{$uri}?book1={$book1}&amp;chap1={concat(replace($chap1, '(GW[0-9]+n)[0-9]+$', '$1'), string($chap-number1 - 1))}&amp;book2={$book2}&amp;chap2={$chap2}">
                                        {syn4:create-button($node, $model, $direction)}
                                    </a>
                    ...
                    case "previous"
                        return
                            if ($book1 eq "") then
                                ...
                                <a
                                    href="{$uri}?book1={$book1}&amp;chap1={$chap1}&amp;book2={$book2}&amp;chap2={concat(replace($chap2, '(GW[0-9]+n)[0-9]+$', '$1'), string($chap-number2 - 1))}">
                                    {syn4:create-button($node, $model, $direction)}
                                </a>
                                (: link changes according to direction. Counting up for "next" :)
                    case "next"
