                        ...
                        case "previous"
                            return
                                if ($vers2 eq "") then
                                    ...
                                    <a
                                        href="{$uri}?vers1={$vers1}&amp;book1={$book1}&amp;chap1={concat(replace($chap1, '(GW[0-9]+[a-z]+)[0-9]+$', '$1'), string($chap-number1 - 1))}&amp;vers2={$vers2}&amp;book2={$book2}&amp;chap2={concat(replace($chap2, '(GW[0-9]+[a-z]+)[0-9]+$', '$1'), string($chap-number2))}">
                                        {syn4:create-button($node, $model, $direction)}
                                    </a>
                    ...
                    case "previous"
                        return
                            if ($vers1 eq "") then
                                ...
                                <a
                                    href="{$uri}?vers1={$vers1}&amp;book1={$book1}&amp;chap1={concat(replace($chap1, '(GW[0-9]+[a-z]+)[0-9]+$', '$1'), string($chap-number1))}&amp;vers2={$vers2}&amp;book2={$book2}&amp;chap2={concat(replace($chap2, '(GW[0-9]+[a-z]+)[0-9]+$', '$1'), string($chap-number2 - 1))}">
                                    {syn4:create-button($node, $model, $direction)}
                                </a>
                                (: link changes according to direction. Counting up for "next" :)
                    case "next"
